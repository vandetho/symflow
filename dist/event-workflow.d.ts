...
export type WorkflowEvent<T> = AnnounceEvent<T> | GuardEvent<T> | LeaveEvent<T> | EnterEvent<T> | TransitionEvent<T> | CompletedEvent<T> | EnteredEvent<T>;
export type WorkflowEventHandler<T> = ((event: AnnounceEvent<T>) => void) | ((event: GuardEvent<T>) => boolean) | ((event: LeaveEvent<T>) => void) | ((event: EnterEvent<T>) => void) | ((event: TransitionEvent<T>) => void) | ((event: CompletedEvent<T>) => void) | ((event: EnteredEvent<T>) => void);
export {};

...
| Guide | Description |
|-------|-------------|
| [Getting Started](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/getting-started.md) | Installation, first workflow, subpath imports |
| [Engine API](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/engine-api.md) | WorkflowEngine, events, guards, validation, pattern analysis |
| [Subject API](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/subject-api.md) | Workflow\<T\>, marking stores, subject events |
| [Weighted Arcs](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/weighted-arcs.md) | Multi-token transitions |
| [Middleware](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/middleware.md) | Composable lifecycle hooks |
| [CLI](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/cli.md) | validate, mermaid, dot commands |
| [Persistence Formats](https://github.com/vandetho/symflow/blob/main/packages/ts/docs/persistence-formats.md) | YAML, JSON, TypeScript, PHP, Mermaid, Graphviz |

## Laravel / PHP

Looking for the PHP version? See [**laraflow**](https://github.com/vandetho/laraflow) -- the same engine for Laravel 11+.
